...
public class HuffmanDecoderTest
{
	...
	public HuffmanDecoderTest(ITestOutputHelper testOutputHelper)
	{
	...
	public void Test1()
	{
		byte[] data = new byte[] { 0b_10101110, 0b_11000011, 0b_01110111, 0b_00011010, 0b_01001011 };
		string str = "private";
		long start;
		string? outd;
		long end;
		start = DateTimeOffset.UtcNow.ToUnixTimeMilliseconds();
		outd = HuffmanTool.DecoderToString(data);
		end = DateTimeOffset.UtcNow.ToUnixTimeMilliseconds();
		Assert.Equal(outd, str);
		OutputHelper.WriteLine((end - start) + "ms " + (outd != null && outd.Equals(str) ? "ok" : "error"));
	}
	[Fact]
	public void Test2()
	{
